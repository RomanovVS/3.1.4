...
async function labelsForTable() {
    let tableLabels = $('#toggleTableAndUsers')
    tableLabels.empty();
    let labels = `<div  style="background: #eeeeea"><h3><small><b>All users </b></small></h3></div>
                <div class="p-3">
