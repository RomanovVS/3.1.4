    ...
    user.then(user => {
        let bodyForm = `
            ...
            <form class="form-group" id="deleteUser" action="api/users/${id}" method="post">
                ...
                <input disabled type="text" class="form-control" id="idD" name="id" value="${user.id}" disabled><br>
                <label for="firstNameD"><b>First Name</b></label>
                <input disabled class="form-control" type="text" id="firstNameD" name="firstName" value="${user.firstName}"><br>
                <label for="lastNameD"><b>Last Name</b></label>
                <input disabled class="form-control" type="text" id="lastNameD" name="lastName" value="${user.lastName}"><br>
                <label for="ageD"><b>Age</b></label>
                <input disabled class="form-control" id="ageD" type="number" name="age" value="${user.age}">
                <label for="emailD"><b>Email</b></label>
                <input disabled class="form-control" type="email" id="emailD" name="email" value="${user.email}"><br>
                <label for="passwordD"><b>Password</b></label>
                <input disabled class="form-control" type="password" id="passwordD" name="password" value="${user.password}"><br>
                <label for="roleD"><b>Roles</b></label>
                <select disabled multiple class="form-control" id="roleD" name="rolesList" size="2">
                       <option>ADMIN</option>
                       <option>USER</option>
                </select>
            </form>
